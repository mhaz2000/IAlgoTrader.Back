using IAlgoTrader.Back.Base.Helpers;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.Mvc;
using System.Security.Claims;

namespace IAlgoTrader.Back.Base
{
    [Authorize]
    [ApiController]
    public class ApiControllerBase : ControllerBase
    {
        ...
        protected virtual string Name => ClaimHelper.GetClaim<string>(this.AccessToken, ClaimTypes.Name);
